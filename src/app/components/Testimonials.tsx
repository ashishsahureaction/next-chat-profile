...
const Testimonials = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-start justify-center min-h-screen py-2 px-10 rounded-3xl ml-24 ">
        <div className=" mt-0">
        ...
        <div className="mt-10  ml-80 grid grid-cols-1 md:grid-cols-3 gap-3 max-w-6xl w-50 h-60 mr-20 ">
