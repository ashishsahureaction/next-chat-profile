...
const TimelineOne: React.FC = () => {
  ...
  return (
	...
	<section className='website-section'>
      <div className="container max-w-5xl px-4 py-12 mx-auto js-content-opacity ">
        <div className="grid gap-4 mx-4 sm:grid-cols-12">
          <div className="col-span-12 sm:col-span-3">
            <div className="text-center sm:text-left mb-14 before:block before:w-24 before:h-3 before:mb-5 before:rounded-md before:mx-auto sm:before:mx-0 before:bg-orange-600 before:dark:bg-orange-600">
              <h3 className="text-3xl font-semibold">Ashish Sahu</h3>
              <span className="text-sm font-bold tracking-wider uppercase text-gray-500 dark:text-gray-600">Full- Stack Developer</span>
            </div>
          </div>
          <div className="relative col-span-12 px-4 space-y-6 sm:col-span-9 text-left">
            <div className="col-span-12 space-y-12 relative px-4 sm:col-span-8 sm:space-y-8 sm:before:absolute sm:before:top-2 sm:before:bottom-0 sm:before:w-0.5 sm:before:-left-3 before:bg-gray-700 before:dark:bg-gray-300">
              <div className="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 
              sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:bg-orange-600 before:dark:bg-orange-600">

<Link href='card/cencora' passHref>
<h3 className="text-xl font-semibold tracking-wide hover:underline hover:text-primary">Cencora </h3>
                  </Link>
                <time className="text-xs tracking-wide text-gray-500 dark:text-gray-600">Senior React JS / Frontend Software Developer</time>
                <time className="text-xs tracking-wide uppercase text-gray-400 dark:text-gray-600">Apr 2019 – Present</time>
                <p className="mt-3">Modernizing Communication Analysis and Review System which helps users to improve productivity by 30%.</p>
              </div>

              <div className="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:bg-orange-600 before:dark:bg-orange-600">
			  <Link href='card/future' passHref>
				<h3 className="text-xl font-semibold tracking-wide hover:underline hover:text-primary">Generali Global Health Services</h3>
				</Link>
                <time className="text-xs tracking-wide text-gray-500 dark:text-gray-600">Senior React, Angular / Frontend Web Developer</time>
                <time className="text-xs tracking-wide uppercase text-gray-500 dark:text-gray-600">July 2016 – Mar 2019</time>
                <p className="mt-3">A content management system (CMS) is built for internal users to use, edit, and customize information as per their needs.</p>
              </div>
              <div className="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:bg-orange-600 before:dark:bg-orange-600">
			  <Link href='card/skylives' passHref>
			    <h3 className="text-xl font-semibold tracking-wide hover:underline hover:text-primary">Skyylines Infotech</h3>
				</Link>
                <time className="text-xs tracking-wide text-gray-500 dark:text-gray-600">React JS / Frontend Software Developer</time>
                <time className="text-xs tracking-wide uppercase text-gray-500 dark:text-gray-600">Jan 2016</time>
                <p className="mt-3">Manage quote pricing systems for the TEBT application, efficiently managing counters.</p>
              </div>
            </div>
          </div>
        </div>
