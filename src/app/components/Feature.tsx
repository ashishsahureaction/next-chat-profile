        ...
        <div className="container mx-auto text-center lg:text-left xl:px-32">
          <div className="grid items-center lg:grid-cols-2">
            <div className="mb-12 lg:mb-0">
              <div className="relative z-[1] block rounded-lg bg-[hsla(0,0%,100%,0.55)] px-6 py-12 
              shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] backdrop-blur-[30px]
               dark:bg-[hsla(0,0%,5%,0.55)] dark:shadow-black/20 md:px-12 lg:-mr-14">
                ...
                seamless experiences, where every interaction leaves a lasting impression of satisfaction. 
                Collaborative efforts among teams ensure that diverse perspectives merge harmoniously, leading to the
                 ...
                 ensuring that every feature sparkles with efficiency and reliability. The ultimate goal is to not just meet but exceed
                  expectations, dazzling users with innovative functionalities and flawless performance. In this pursuit, the software
                   ...
                   users, captivating them with each interaction.                </p>
              </div>
            </div>
