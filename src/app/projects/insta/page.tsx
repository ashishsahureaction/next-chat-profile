        ...
        <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16 shadow-lg inset-shadow-lg">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16 shadow-lg inset-shadow-lg">
            ...
            <div className="lg:py-24">
              <h2 className="text-3xl font-bold sm:text-4xl">Instagram App</h2>

              <p className="mt-4 text-justify">
              Share moments, connect with friends, and discover the world – all in one place. Welcome to Instagram, where every scroll tells a story.
              </p>
              <Link href="https://intsagram-nextjs-clone-eynq.vercel.app/" target="_blank" rel="noreferrer" className="relative flex items-center justify-center w-32 h-[46px] mt-4 rounded
  ...
  <span className="ml-1"><IoMdArrowForward  size={18}  /></span>
      ...
      <section className="space-y-6 text-justify mx-auto max-w-3xl px-3 py-10">
        <section className="space-y-3">
          ...
          <p>
          Instagram, a leading social media platform, has revolutionized the way we share and connect. 
          With its user-friendly interface and diverse features like Stories and Reels, it offers a space for creativity and self-expression. 
          From sharing everyday moments to exploring global trends, Instagram brings people together in a digital community where every post tells a story.
          </p>
        </section>
  ...
  <div className="container mx-auto p-4 text-justify">
    <ul className="list-disc">
      ...
      <li className="text-green-600 flex items-center">
        <RxExternalLink className="mr-2" />
        <span>NextAuth</span> 
        <span className="text-pink-600 ml-2">: Authentication and Authorization</span>
      </li>
      <li className="text-green-600 flex items-center">
        <RxExternalLink className="mr-2" />
        <span>Google Firebase</span> 
        <span className="text-pink-600 ml-2">: Storage and Database</span>
      </li>
      <li className="text-green-600 flex items-center">
        <RxExternalLink className="mr-2" />
        <span>React Moment</span> 
        <span className="text-pink-600 ml-2">: Timestamp</span>
      </li>
      <li className="text-green-600 flex items-center">
        <RxExternalLink className="mr-2" />
        <span>V0</span> 
        <span className="text-pink-600 ml-2">: Customization</span>
      </li>
    </ul>
  </div>
</section>
        ...
        <section className="space-y-4 text-justify">
          ...
          <p>
          App address concerns regarding content moderation, algorithmic biases, and privacy to maintain user trust. Overcoming these challenges gives innovative solutions and a commitment to fostering a safe, inclusive, and transparent platform for its diverse user base.
        ...
        <section className="space-y-3">
          ...
          <ul className='list-disc' >
            <li> Allows users to share photos and videos with their followers, either publicly or privately.</li>
            <li>Users can post ephemeral content that disappears after 24 hours, offering a more casual and spontaneous way to share moments.</li>
