      ...
      <div className="container px-6 py-10 mx-auto">
        <div className="lg:flex lg:items-center">
          <div className="w-full space-y-12 lg:w-1/2">
            <div>
              <h1 className="text-2xl font-semibold capitalize lg:text-3xl">Cencora <br /> Full-Stack Developer</h1>
              <div className="mt-2">
            ...
            <InfoSection
              ...
              description="From April 2019 - To Present"
            />
            <InfoSection
