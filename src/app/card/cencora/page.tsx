...
const Cencora = () => {
  return (
    <div className="h-screen flex items-center justify-center">
      <div className="w-[500px] rounded-lg overflow-hidden shadow-md hover:scale-105 duration-700">
        <Image
          src={cen}
          width={400}
          height={400}
        ...
        <div className="py-10 px-6 grid grid-cols-1 gap-6">
          ...
          <p className="text-center text-gray-500">
            NextJs, ReactJs, JavaScript, NodeJs, Redux, ExpressJs, Tailwind,
            Jasmine, Typescript, StoryBook, SASS, HTML5.
          </p>
          <div className="flex items-center justify-center space-x-2">
            ...
            <a
              href="#"
              className="w-10 h-10 flex items-center justify-center bg-gray-800 rounded-full"
            >
